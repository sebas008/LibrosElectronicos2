...
<body>
	<form action="<%=request.getContextPath()%>/Servlet" method="post">
		<input type="hidden" name="opcion" value="RegistrarEstadoDoc">
		<table width="40%" align="center">
			<tr>
				<td colspan="2"><h1 class="titulo">Registro de Estados de Documentos</h1><hr class="raya" /></td>
			</tr>
			<tr align="left">
				<td>Codigo:</td>
		...
		<table align="center" width="50%">
			<tr>
				...
				<td width="50%"align="center"> <a href="<%=request.getContextPath()%>/SUNAT_Estado_Documento.jsp"  TARGET="central" ><input type="button" value="Cancelar" class="botonCancelar"></a></td>
			</tr>
		</table>
