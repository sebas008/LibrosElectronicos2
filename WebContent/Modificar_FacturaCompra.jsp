...
<body>
	<form action="<%=request.getContextPath()%>/Servlet" method="post">
		<input type="hidden" name="opcion" value="ModificarFacturaCompra">
		<table width="40%" align="center">
			<tr>
				<td colspan="2"><h1 class="titulo">Modificar Factura Compra </h1>
					<hr class="raya" /></td>
			</tr>
			<tr align="left">
				<td>Periodo:</td>
			...
			<tr align="left">
				...
				<td><input type="text" name="txtFechaRet" size="40" value="<c:out value="${objeto.fechaRet}"  escapeXml="true"/>"></td>
			</tr>
			<tr align="left">
				<td>Nro. Retencion:</td>
				<td><input type="text" name="txtNroRet" size="40" value="<c:out value="${objeto.nroRet}"  escapeXml="true"/>"></td>
			</tr>
			<tr align="left">
				<td>Monto Rentecion:</td>
				<td><input type="text" name="txtMontoRet" size="40" value="<c:out value="${objeto.montoRet}"  escapeXml="true"/>"></td>
			</tr>
			<tr align="left">
				<td>Glosa Compra:</td>
			...
			<tr align="left">
				<td>Codigo Compra:</td>
				<td><input type="text" name="txtCodCom" size="40" value="<c:out value="${objeto.codcom}"  escapeXml="true"/>"></td>
			</tr>
			<tr align="left">
				<td>Codigo Estado:</td>
