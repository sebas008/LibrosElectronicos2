...
<link rel="stylesheet" type="text/css" media="screen"
	href="css/screen.css" />
<!-- ... -->
<title>SUNAT | TABLA TIPO CLIENTE</title>
</head>
...
<body>
	...
	<a href="<%=request.getContextPath()%>/Nuevo_TipoCliente.jsp"
		TARGET="central"><input type="button" value="Nuevo"
		class="botonNuevo"></a>
	<a href="<%=request.getContextPath()%>/Servlet?opcion=listaTipoCliente"
	...
	<display:table name="${listadoTipoCliente}" pagesize="20" export="true"
		...
		<display:column title="Modificar">
			<a
				href="<%=request.getContextPath()%>/Servlet?opcion=ObtenerTipoCliente&codigo=<c:out value="${objeto.codigo}"  escapeXml="true"/>">Modificar</a>
		</display:column>
		<display:column title="Eliminar">
			<a
				href="<%=request.getContextPath()%>/Servlet?opcion=EliminarTipoCliente&codigo=<c:out value="${objeto.codigo}"  escapeXml="true"/>">Eliminar</a>
		</display:column>
