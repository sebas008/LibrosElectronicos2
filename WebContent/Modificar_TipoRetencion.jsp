...
<body>
	<form action="<%=request.getContextPath()%>/Servlet" method="post">
		<input type="hidden" name="opcion" value="ModificarTipoRetencion">
		<table width="40%" align="center">
			<tr>
				<td colspan="2"><h1 class="titulo">Modificar Tipo Retencion </h1>
					<hr class="raya" /></td>
			</tr>
			<tr align="left">
				<td>Codigo:</td>
			...
			<tr align="left">
				<td>Tasa:</td>
				<td><input type="text" name="txtTasa" size="40" value="<c:out value="${objeto.tasa}"  escapeXml="true"/>"></td>
			</tr>
			<tr align="left">
				<td>Valor:</td>
				<td><input type="text" name="txtValor" size="40" value="<c:out value="${objeto.valor}"  escapeXml="true"/>"></td>
			</tr>
